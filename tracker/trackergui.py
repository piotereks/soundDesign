...
class TrackerGuiApp(App):
    ...
    def on_start(self):
        ...
        self.tracker_ref.set_loop_action = lambda: self.set_loop_state(loop_button=self.tracker_ref.midi_mapping['loop'])
    ...
    def save(self):
        self.tracker_ref.save_midi()

    def set_scale_app(self, instance, scale_name):
        log_call()
        self.set_scale_mn(scale_name)  # TODO review this
    ...
    def rand_play_func(self):
        ...
        self.tracker_ref.note_patterns.set_pattern_function(selected_function)
